            ...
            <div id="wrapper_module" class="toggled">
                <div class="dropdown">
                    <button class="btn btn-secondary btn-lg dropdown-toggle"
                        ...
                        aria-expanded="false">Modules</button>
                ...
                <div class="Space_link_Class">
                    <a href="<c:url value="/exhibit/space/${spaceId}"/>">Go
                        to ${spaceName}</a>
                </div>
                    ...
                    <c:forEach items="${currentSlideCon.contents}"
                        ...
                        <c:if
                            ...
                            <div id="${contents.id}" class="textDiv"
                                style="margin: 10px; text-align: justify; padding-right: 225px; padding-left: 225px">
                                <p>${contents.text}</p>
                            </div>
                        </c:if>
                    </c:forEach>
