        ...
        <c:if test="${error == null}">
            <div id="wrapper_module" class="toggled">
                <div class="dropdown">
                    ...
                    <i class="fas fa-bars fa-2x" style="position: absolute" onclick="openNav()"></i>
                            ...
                            <a
                                ...
                                <div
                                    ...
                                    <ellipse fill="rgba(255,255,255,1)"
                                            class="Ellipse_11_Class"
                                            rx="20" ry="20" cx="20"
                                            cy="20">
                                    </ellipse>
                                </svg>
                                    <svg
                                        class="Icon_ionic_ios_arrow_back"
