...
<link rel="stylesheet" type="text/css" id="applicationStylesheet" href="<c:url value="/resources/extra/Module_1___slideshow___1.css" />">
<script id="applicationScript" src="<c:url value="/resources/extra/Module_1___slideshow___1.js" />"></script>
...
<script>
	$(window).on('load', function() {
		$('.Module_1___slideshow___1_Class').hide();
	...
	function startSlideShow(){
		//document.getElementsByClassName('Group_8_Class').remove();
		$('.Module_1_Class').remove();
		$('.Module_1___slideshow___1_Class').show();
		/*$.ajax({
			type: "GET",
	...
	$(document).ready(function(){
		...
		$(".Ellipse_12").on("click", function(e){
			$('#slidesList').first().children().next().children()[0].click();
			$('.Module_1_Class').remove();
			$('.Module_1___slideshow___1_Class').show();
		});
	})
...
<div class="container">
	<div id="Module_1" class="Module_1_Class">
		...
		<div class="Component_31___13 Component_31___13_Class">
			<div
				onclick="application.showOverlay('Language_options',1019,0, event)"
				class="Mask_Group_9_Class">
				<svg style="width: inherit; height: inherit; overflow: visible;">
			<rect fill="url(#Mask_Group_9_bq_pattern)" width="100%" height="100%"></rect>
				<pattern elementId="Mask_Group_9_bq" id="Mask_Group_9_bq_pattern"
						x="0" y="0" width="100%" height="100%">
					<image x="0" y="0" width="100%" height="100%"
						href="Mask_Group_9_bq_pattern.png"
						xlink:href="Mask_Group_9_bq_pattern.png"></image>
				</pattern>
				</svg>
			</div>
		</div>
		<div onclick="startSlideShow()"
			class="SLideshow_option SLideshow_option_Class">
			<svg class="Ellipse_2">
	...
	<div class="Back_to_first Back_to_first_Class">
		...
		<svg class="Icon_material_first_page" viewBox="9 9 18 17.405">
			<path fill="rgba(150,45,62,1)" class="Icon_material_first_page_Class" d="M 27 24.36019325256348 L 20.34246635437012 17.70265769958496 L 27 11.04512405395508 L 24.95487976074219 9 L 16.25221633911133 17.70265769958496 L 24.95487976074219 26.40531730651855 L 27 24.36019325256348 Z M 9.000000953674316 9 L 11.90088748931885 9 L 11.90088748931885 26.40531730651855 L 9.000000953674316 26.40531730651855 L 9.000000953674316 9 Z">
			</path>
		</svg>
	</div>
	...
	<div class="Map Map_Class">
		...
		<div class="Icon_awesome_map Icon_awesome_map_Class">
			<svg class="Icon_awesome_map_bg" viewBox="0 2.25 24 18.667">
				<path fill="rgba(150,45,62,1)" class="Icon_awesome_map_bg_Class" d="M 0 5.819166660308838 L 0 20.24916839599609 C 0 20.72083282470703 0.476250022649765 21.04333114624023 0.9141667485237122 20.86833572387695 L 6.666666984558105 18.25 L 6.666666984558105 2.25 L 0.8383333683013916 4.581250190734863 C 0.3321118056774139 4.783724784851074 0.0001215051670442335 5.273954391479492 1.412850849646929e-07 5.819165706634521 Z M 8 18.25 L 16 20.91666793823242 L 16 4.916666984558105 L 8 2.25 L 8 18.25 Z M 23.08583641052246 2.298333644866943 L 17.33333587646484 4.916666984558105 L 17.33333587646484 20.91666793823242 L 23.16166496276855 18.58541870117188 C 23.66796493530273 18.38303375244141 23.99999618530273 17.89274597167969 24 17.34749984741211 L 24 2.917500257492065 C 24 2.445833444595337 23.52375030517578 2.12333345413208 23.08583641052246 2.298333644866943 Z">
				</path>
			</svg>
		</div>
	</div>
	...
	<div class="Component_31___15 Component_31___15_Class">
		<div onclick="application.showOverlay('Language_options',1019,0, event)" class="Mask_Group_9_Class">
		<svg style="width:inherit;height:inherit;overflow:visible;">
			<rect fill="url(#Mask_Group_9_br_pattern)" width="100%" height="100%"></rect>
				<pattern elementId="Mask_Group_9_br" id="Mask_Group_9_br_pattern" x="0" y="0" width="100%" height="100%">
					<image x="0" y="0" width="100%" height="100%" href="Mask_Group_9_br_pattern.png" xlink:href="Mask_Group_9_br_pattern.png"></image>
				</pattern>
				</svg>
			</div>
	</div>
	<c:forEach items="${currentSlideCon.contents}" var="contents">
				<c:if test="${contents['class'].simpleName ==  'ImageBlock'}">
					<img id="${contents.id}" class=Image_14_Class
						src="<c:url value="/api/image/${contents.image.id}" />" />
				</c:if>
				</c:forEach>
	<div class="Experimental_demonstration__Ph_Class">
		<c:forEach items="${currentSlideCon.contents}" var="contents">
				<c:if test="${contents['class'].simpleName ==  'TextBlock'}">
					<p>${contents.text}</p>
				</c:if>
	...
	<div onclick="application.goToTargetView(event)" class="exit_to_space exit_to_space_Class">
		<svg class="Ellipse_5_bp">
			<ellipse fill="rgba(255,255,255,1)" class="Ellipse_5_bp_Class" rx="22" ry="22" cx="22" cy="22">
			</ellipse>
		</svg>
