	...
	<div class="col-4">
		...
		<div class="jumbotron">
			<sec:authorize access="isAnonymous()">
				<form name='f' class="form-horizontal" action="<c:url value="" />"
					method="POST">
				...
				<div class="float-right">
					<small> Don't have an account yet? <a
						href="<c:url value="/register" />">Sign up!</a><br> Forgot
						your password? <a href="<c:url value="/reset/password/request" />">Reset
							it!</a>
					</small>
				</div>
			</sec:authorize>
