...
<body>
	<div class="container" style="padding-bottom: 150px;">
		...
		<div class="page-header">
				...
				<ul class="nav nav-pills pull-right">
					...
					<sec:authorize access="isAuthenticated()">
						<li role="presentation"><a
							href="<c:url value="/staff/space/list" />">Spaces</a></li>
			...
			<h1>
				<a class="appName" href="<c:url value="/" />">My new webapp</a>
			</h1>
						...
						<sec:authorize access="isAnonymous()">
							...
							<form name='f' class="form-horizontal pull-right"
								...
								Login: <input type="hidden" name="${_csrf.parameterName}"
									value="${_csrf.token}" /> <br> <input
									placeholder="Username" class="form-control input-sm"
									type="text" id="username" name="username" /> <br> <input
