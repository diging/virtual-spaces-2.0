...
<link
	...
	rel="stylesheet">
<link href="<c:url value="/resources/jquery/jquery-ui.min.css" />"
	rel="stylesheet">

<!-- Custom styles for this template -->
<link href="<c:url value="/resources/bootstrap-4.1.2/dashboard.css" />"
	rel="stylesheet">
...
<body>
	...
	<nav
		class="navbar navbar-dark fixed-top bg-purple flex-md-nowrap p-0 shadow">
		<a class="navbar-brand col-sm-3 col-md-2 mr-0"
			href="<c:url value="/" />">Virtual Spaces 2.0</a> <input
				...
				<div class="sidebar-sticky">
					<ul class="nav flex-column">
						<li class="nav-item"><a class="nav-link ${currentPage == "
							home" ? "active" : ""}" href="#"> <span data-feather="home"></span>
								Dashboard <span class="sr-only">(current)</span>
						</a></li>
						<li class="nav-item"><a class="nav-link ${currentPage == "
							space" ? "active" : ""}" href="<c:url value="/staff/space/list" />">
								<span data-feather="box"></span> Spaces
						</a></li>
						<li class="nav-item"><a class="nav-link ${currentPage == "
							module" ? "active" : ""}" href="<c:url value="/staff/module/list" />">
								<span data-feather="share-2"></span> Modules
						</a></li>
						<li class="nav-item"><a class="nav-link ${currentPage == "
							exhibit" ? "active" : ""}" href="<c:url value="/staff/exhibit/econfig" />">
								<span data-feather="settings"></span> Exhibition Configuration
						</a></li>
					</ul>
