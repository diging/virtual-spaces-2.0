        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <sec:authorize access="hasAnyRole('ADMIN', 'STAFF')">
                <li class="nav-item">
                  <a class="nav-link ${currentPage == " space" ? "active" : "" }"
                    href="<c:url value="/staff/space/list" />">
                  <span data-feather="box"></span>
                  Spaces
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link ${currentPage == " module" ? "active" : "" }"
                ...
                <li class="nav-item">
                  <a class="nav-link ${currentPage == " images" ? "active" : "" }"
                    href="<c:url value="/staff/images/list/1" />">
              ...
              <sec:authorize access="hasRole('ADMIN')">
                <li class="nav-item">
                  <a class="nav-link ${currentPage == " users" ? "active" : "" }"
                    href="<c:url value="/staff/user/list" />">
