...
public class SequenceController {
    ...
    public String getSequence(Model model, @PathVariable("moduleId") String moduleId, @PathVariable("id") String sequenceId, @ModelAttribute SequenceForm sequenceForm,
            Principal principal) {
