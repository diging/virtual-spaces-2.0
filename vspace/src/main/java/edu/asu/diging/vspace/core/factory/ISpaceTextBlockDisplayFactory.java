...
public interface ISpaceTextBlockDisplayFactory {
    ISpaceTextBlockDisplay createSpaceTextBlockDisplay(ISpaceTextBlock textBlock, float positionX, float positionY, float height, float width, String textColor);
}
