...
public class EditSlideLinksController {
    ...
    protected ResponseEntity<String> checkIfSlideExists(ISlideManager slideManager, String id) throws IOException{
    ...
    protected ResponseEntity<String> success(String id, String url, String label, String  displayId, float posX, float posY, int rotation, String displayType, String linkedId, String linkedSlideStatus) throws IOException{
