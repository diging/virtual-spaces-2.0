...
public class SpaceDisplay implements ISpaceDisplay {
	...
	/* (non-Javadoc)
	 * @see edu.asu.diging.vspace.core.model.display.impl.ISpaceDisplay#setId(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.asu.diging.vspace.core.model.display.impl.ISpaceDisplay#setSpace(edu.asu.diging.vspace.core.model.ISpace)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.asu.diging.vspace.core.model.display.impl.ISpaceDisplay#setWidth(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.asu.diging.vspace.core.model.display.impl.ISpaceDisplay#setHeight(int)
	 */
	@Override
