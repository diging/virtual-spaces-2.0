...
@Controller
public class ExhibitionPreviewSlideController {
    ...
    @RequestMapping(value = "/exhibition/preview/{spaceId}/module/{moduleId}/sequence/{sequenceId}/slide/{slideId}", method = RequestMethod.GET)
