...
public class ImagesSearchFullApiController {
    ...
    private ISpaceManager spaceManager;
	  ...
	  public String imageSearchFull(Model model ,@RequestParam(value = "searchText", required = false) String searchTerm) { 
    ...
    public String imageSeacrhDescription(@PathVariable(required = false) String page,
            @RequestParam(value = "searchText", required = false) String searchTerm , Model model, RedirectAttributes attributes){
