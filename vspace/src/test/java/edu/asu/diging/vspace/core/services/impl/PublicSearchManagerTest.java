...
public class PublicSearchManagerTest {
    ...
    public void test_searchInSpaces_success() {
        ...
        String search = "space";
        when(spaceManager.findBySpaceStatusAndNameOrDescription(requestedPage, SpaceStatus.PUBLISHED, search)).thenReturn(new PageImpl<Space>(spaces));
    ...
    public void test_searchInSpaces_pageGreaterThanTotalPages() {
        ...
        when(spaceManager.findBySpaceStatusAndNameOrDescription(requestedPage1, SpaceStatus.PUBLISHED, search)).thenReturn(new PageImpl<Space>(spaces));
