...
public class SpaceLinkManagerTest {
    ...
    private String spaceId1, spaceId2, spaceId3, imageId, imageId2, imageFileName, spcDisplayLinkId, spaceLinkId1;
    ...
    public void test_createLinkWithExistingImage_success() throws SpaceDoesNotExistException, ImageCouldNotBeStoredException, ImageDoesNotExistException, FileStorageException {
        ...
        ISpaceLinkDisplay savedSpaceLinkDisplay2 = managerToTest.createLink("New Space Link", spaceId1, 10, 30, 40, spaceId2, "New Space Link", "New Space Link Desc", DisplayType.IMAGE, new byte[20], imageFileName, null);
        ...
        Assert.assertEquals(spaceDisplayLinkImage.getDescription(), savedSpaceLinkDisplay2.getDescription());
    ...
    public void test_updateLink_success() throws SpaceDoesNotExistException, LinkDoesNotExistsException, ImageCouldNotBeStoredException , ImageDoesNotExistException{
        ...
        ISpaceLinkDisplay actualUpdatedLink = managerToTest.updateLink("TestSpaceEdited", spaceId1, 100, 300, 180, spaceId3, "TestSpaceEdited","New Space Link Desc", "SPL002", "SPLD001", DisplayType.ALERT, null, null, null);
    ...
    public void test_updateLinkWithExistingImage_success() throws SpaceDoesNotExistException, LinkDoesNotExistsException, ImageCouldNotBeStoredException, ImageDoesNotExistException {
        ...
        Mockito.when(spaceLinkRepo.save((SpaceLink) spaceLink)).thenReturn((SpaceLink)spaceLink);
        Mockito.when(spaceLinkDisplayRepo.save((SpaceLinkDisplay)spaceLinkDisplay)).thenReturn((SpaceLinkDisplay)spaceLinkDisplayUpdated);
        Mockito.when(imageService.getImageById(imageId2)).thenReturn(spcImage);
        ...
        Assert.assertEquals(spaceLinkDisplayUpdated.getDescription(), savedSpaceLinkDisplay2.getDescription());
