...
public class SpaceLinkManagerTest {
    ...
    public void test_updateLink_success() throws SpaceDoesNotExistException, LinkDoesNotExistsException, ImageCouldNotBeStoredException, ImageDoesNotExistException {
        ...
        ISpaceLinkDisplay actualUpdatedLink = managerToTest.updateLink("TestSpaceEdited", spaceId1, 100, 300, 180, spaceId3, "TestSpaceEdited", "TestSpaceEdited Desc", "SPL002", "SPLD001", DisplayType.ALERT, null, null, null);
