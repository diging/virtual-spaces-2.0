...
public class ExternalLinkManagerTest {
    ...
    public void test_updateLink_success() throws SpaceDoesNotExistException, LinkDoesNotExistsException, ImageCouldNotBeStoredException, ImageDoesNotExistException {
        ...
        IExternalLinkDisplay actualUpdatedLink = managerToTest.updateLink("TestExternalNew", spaceId1, 20, 40, 0, "www.google.com", "TestExternalNew",  "Test External Link Desc", "EXL001", "EXLD001", DisplayType.ARROW, null, null, null);
